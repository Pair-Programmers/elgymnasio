        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{ URL::to('/update_expense') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="payee_id">
                                            @foreach ($payees as $payee)
                                                @if ($payee->id == $expense->payee_id)
                                                    <option value="{{$payee->id}}" selected>{{$payee->name}} --> {{$payee->group}} </option>
                                                @endif
                                    ...
                                    <div class="col-sm-4">
                                        <select class="form-control" name="exp_subcategory_id" required>
                                            @foreach ($subcategories as $subcategory)
                                                @if ($expense->exp_subcategory_id == $subcategory->id)
                                                    <option selected value="{{$subcategory->id}}">{{$subcategory->main_category_name}} &nbsp;:&nbsp; {{$subcategory->name}}</option>
                                                @endif
