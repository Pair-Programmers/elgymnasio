                ...
                <div class="ibox float-e-margins">
                    ...
                    @foreach($packages as $package)
                        <tr class="gradeX">
                            ...
                            <td class="center">{{$package->no_of_months}}</td>
                            <td class="center">@foreach($package->services as $service) {{$service}},@endforeach</td>
                            <td>
                                <a href="{{ url('/display_edit_package', ['id' => $package->id]) }}">
                                    <small class="label label-primary"><i class="fa"></i>Edit</small>
                                </a>
                                <a href="{{ url('/delete_package', ['id' => $package->id]) }}">
