            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    @foreach($expenses as $expense)
                        <tr class="gradeX">
                            <td>{{$counter}}</td>
                            <td class="center">{{$expense->payee_name}}</td>
                            <td class="center">{{$expense->amount}}</td>
                            <td class="center">{{$expense->account_name}}</td>
                            <td class="center">{{$expense->category_name}} &nbsp;:&nbsp; {{$expense->subcategory_name}}</td>
                            <td class="center">{{$expense->date}}</td>
                            
                            <td>
                                <a href="{{ url('/display_edit_expense', ['id' => $expense->id]) }}">
                                    <small class="label label-primary"><i class="fa"></i>Edit</small>
                                </a>
                                <a href="{{ url('/delete_expense', ['id' => $expense->id]) }}">
