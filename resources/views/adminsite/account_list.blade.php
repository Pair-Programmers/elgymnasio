                    ...
                    <div class="ibox float-e-margins">
                        ...
                        @foreach($accounts as $account)
                            <tr class="gradeX">
                                ...
                                <td class="center">{{$account->bank_name}}</td>
                                <td class="center">{{$account->account_title}}</td>
                                <td class="center">{{$account->account_number}}</td>
                                <td class="center">{{$account->opening_balance}}</td>
                                <td class="center">43</td>
                                <td>
                                    <a href="{{ url('/display_account_edit', ['id' => $account->id]) }}">
                                        <small class="label label-primary"><i class="fa"></i>Edit</small>
                                    </a>
                                    <a href="{{ url('/delete_account', ['id' =>$account->id]) }}">
