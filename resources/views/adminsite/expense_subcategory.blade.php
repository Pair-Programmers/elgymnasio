    ...
    <?=$sidebar; ?>
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Create Expense SubCategory</h2>
                    <ol class="breadcrumb">
                        <li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="{{URL::to('save_exp_subcategory')}}" enctype="multipart/form-data">
                                @csrf
